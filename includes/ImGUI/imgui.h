...
namespace ImGui
{
    ...
    static inline ImVec2 CalcItemRectClosestPoint(const ImVec2& position, bool on_edge = false, float outward = 0.f) { IM_UNUSED(on_edge); IM_UNUSED(outward); IM_ASSERT(0); return position; }
}
