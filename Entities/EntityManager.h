...
#pragma region ForEach
		...
		static void ForEachStorage(EntityComponentStorage storage,
		...
		template <typename T1 = ComponentBase, typename T2 = ComponentBase, typename T3 = ComponentBase, typename T4 =
		          ComponentBase>
		static void ForEachStorage(EntityComponentStorage storage,
		                           const std::function<void(int i, Entity entity, T1*, T2*, T3*, T4*)>& func);
		template <typename T1 = ComponentBase, typename T2 = ComponentBase, typename T3 = ComponentBase, typename T4 =
		          ComponentBase, typename T5 = ComponentBase>
		static void ForEachStorage(EntityComponentStorage storage,
		                           const std::function<void(int i, Entity entity, T1*, T2*, T3*, T4*, T5*)>& func);
		template <typename T1 = ComponentBase, typename T2 = ComponentBase, typename T3 = ComponentBase, typename T4 =
		          ComponentBase, typename T5 = ComponentBase, typename T6 = ComponentBase>
		static void ForEachStorage(EntityComponentStorage storage,
		                           const std::function<void(int i, Entity entity, T1*, T2*, T3*, T4*, T5*, T6*)>& func);
		template <typename T1 = ComponentBase, typename T2 = ComponentBase, typename T3 = ComponentBase, typename T4 =
		          ComponentBase, typename T5 = ComponentBase, typename T6 = ComponentBase, typename T7 = ComponentBase>
		static void ForEachStorage(EntityComponentStorage storage,
		                           const std::function<void(int i, Entity entity, T1*, T2*, T3*, T4*, T5*, T6*, T7*)>&
		                           func);
		template <typename T1 = ComponentBase, typename T2 = ComponentBase, typename T3 = ComponentBase, typename T4 =
		          ComponentBase, typename T5 = ComponentBase, typename T6 = ComponentBase, typename T7 = ComponentBase,
		          typename T8 = ComponentBase>
		static void ForEachStorage(EntityComponentStorage storage,
		                           const std::function<void(int i, Entity entity, T1*, T2*, T3*, T4*, T5*, T6*, T7*,
		                                                    T8*)>& func);
...
#pragma endregion
	...
	public:
		static void ForEachComponentUnsafe(Entity entity,
		                                   const std::function<void(ComponentType type, void* data)>& func);
		...
		template <typename T1 = ComponentBase, typename T2 = ComponentBase, typename T3 = ComponentBase>
		static void ForEach(EntityQuery entityQuery,
		                    const std::function<void(int i, Entity entity, T1*, T2*, T3*)>& func);
		template <typename T1 = ComponentBase, typename T2 = ComponentBase, typename T3 = ComponentBase, typename T4 =
		          ComponentBase>
		static void ForEach(EntityQuery entityQuery,
		...
		template <typename T1 = ComponentBase, typename T2 = ComponentBase, typename T3 = ComponentBase, typename T4 =
		          ...
		          typename T8 = ComponentBase>
		static void ForEach(EntityQuery entityQuery,
		                    const std::function<void(int i, Entity entity, T1*, T2*, T3*, T4*, T5*, T6*, T7*, T8*)>&
		                    func);
...
#pragma region ForEachStorage
	...
	void EntityManager::ForEachStorage(EntityComponentStorage storage,
	                                   const std::function<void(int i, Entity entity, T1*)>& func)
	{
					...
					_ThreadPool->Push([entities, capacity, func, chunkIndex, data, targetType1](int id)
						{
							for (size_t i = 0; i < capacity; i++)
							{
								...
								func(static_cast<int>(index), entity,
								     static_cast<T1*>(static_cast<char*>(data) + targetType1.Offset * capacity + (i %
									     capacity) * targetType1.Size)
								);
							}
						}
					).share());
	                                   ...
	                                   const std::function<void(int i, Entity entity, T1*, T2*)>& func)
	{
		...
		if (found1 && found2)
		{
					...
					_ThreadPool->Push([entities, capacity, func, chunkIndex, data, targetType1, targetType2](int id)
						{
							for (size_t i = 0; i < capacity; i++)
							{
								...
								func(static_cast<int>(index), entity,
								     static_cast<T1*>(static_cast<char*>(data) + targetType1.Offset * capacity + (i %
									     capacity) * targetType1.Size),
								     static_cast<T2*>(static_cast<char*>(data) + targetType2.Offset * capacity + (i %
									     capacity) * targetType2.Size)
								);
							}
						}
					).share());
			...
			if (remainder != 0)
			{
				...
				results.push_back(
					_ThreadPool->Push(
						[entities, capacity, func, chunkAmount, data, targetType1, targetType2, remainder](int id)
						{
							for (size_t i = 0; i < remainder; i++)
							{
								size_t index = i + chunkAmount * capacity;
	...
	static void EntityManager::ForEachStorage(EntityComponentStorage storage,
	                                          const std::function<void(int i, Entity entity, T1*, T2*, T3*)>& func)
	{
		ComponentType targetType1 = typeof<T1>();
		ComponentType targetType2 = typeof<T2>();
		...
		if (found1 && found2 && found3)
		{
			...
			for (int chunkIndex = 0; chunkIndex < chunkAmount; chunkIndex++)
			{
				...
				results.push_back(
					_ThreadPool->Push(
						[entities, capacity, func, chunkIndex, data, targetType1, targetType2, targetType3](int id)
						{
							for (size_t i = 0; i < capacity; i++)
							{
								size_t index = i + chunkIndex * capacity;
								...
								func(static_cast<int>(index), entity,
								     ...
								     static_cast<T2*>(static_cast<char*>(data) + targetType2.Offset * capacity + (i %
									     capacity) * targetType2.Size),
								     static_cast<T3*>(static_cast<char*>(data) + targetType3.Offset * capacity + (i %
									     capacity) * targetType3.Size)
								);
							}
						}
					).share());
			...
			if (remainder != 0)
			{
				...
				results.push_back(
					_ThreadPool->Push(
						[entities, capacity, func, chunkAmount, data, targetType1, targetType2, targetType3, remainder](
						int id)
						{
							for (size_t i = 0; i < remainder; i++)
							{
	                                          ...
	                                          const std::function<void(int i, Entity entity, T1*, T2*, T3*, T4*)>& func)
	{
		...
		if (found1 && found2 && found3 && found4)
		{
			...
			for (int chunkIndex = 0; chunkIndex < chunkAmount; chunkIndex++)
			{
				...
				results.push_back(
					_ThreadPool->Push(
						[entities, capacity, func, chunkIndex, data, targetType1, targetType2, targetType3, targetType4
						](int id)
						{
							for (size_t i = 0; i < capacity; i++)
							{
								...
								func(static_cast<int>(index), entity,
								     ...
								     static_cast<T3*>(static_cast<char*>(data) + targetType3.Offset * capacity + (i %
									     capacity) * targetType3.Size),
								     static_cast<T4*>(static_cast<char*>(data) + targetType4.Offset * capacity + (i %
									     capacity) * targetType4.Size)
								);
							}
						}
					).share());
			...
			if (remainder != 0)
			{
				...
				results.push_back(
					_ThreadPool->Push(
						[entities, capacity, func, chunkAmount, data, targetType1, targetType2, targetType3, targetType4
							, remainder](int id)
						{
							for (size_t i = 0; i < remainder; i++)
							{
	...
	static void EntityManager::ForEachStorage(EntityComponentStorage storage,
	                                          const std::function<void(int i, Entity entity, T1*, T2*, T3*, T4*, T5*)>&
	                                          func)
	{
		ComponentType targetType1 = typeof<T1>();
		ComponentType targetType2 = typeof<T2>();
							...
							targetType5](int id)
						{
							for (size_t i = 0; i < capacity; i++)
							{
								...
								func(static_cast<int>(index), entity,
								     ...
								     static_cast<T4*>(static_cast<char*>(data) + targetType4.Offset * capacity + (i %
									     capacity) * targetType4.Size),
								     static_cast<T5*>(static_cast<char*>(data) + targetType5.Offset * capacity + (i %
									     capacity) * targetType5.Size)
								);
							}
						}
					).share());
		...
		if (found1 && found2 && found3 && found4 && found5 && found6)
		{
			...
			for (int chunkIndex = 0; chunkIndex < chunkAmount; chunkIndex++)
			{
				...
				results.push_back(
					_ThreadPool->Push(
						[entities, capacity, func, chunkIndex, data, targetType1, targetType2, targetType3, targetType4,
							targetType5, targetType6](int id)
						{
							for (size_t i = 0; i < capacity; i++)
							{
								size_t index = i + chunkIndex * capacity;
								...
								func(static_cast<int>(index), entity,
								     ...
								     static_cast<T5*>(static_cast<char*>(data) + targetType5.Offset * capacity + (i %
									     capacity) * targetType5.Size),
								     static_cast<T6*>(static_cast<char*>(data) + targetType6.Offset * capacity + (i %
									     capacity) * targetType6.Size)
								);
							}
						}
					).share());
			...
			if (remainder != 0)
			{
				...
				results.push_back(
					_ThreadPool->Push(
						[entities, capacity, func, chunkAmount, data, targetType1, targetType2, targetType3, targetType4
							, targetType5, targetType6, remainder](int id)
						{
							for (size_t i = 0; i < remainder; i++)
							{
								size_t index = i + chunkAmount * capacity;
		...
		if (found1 && found2 && found3 && found4 && found5 && found6 && found7)
		{
			...
			for (int chunkIndex = 0; chunkIndex < chunkAmount; chunkIndex++)
			{
				...
				results.push_back(
					_ThreadPool->Push(
						[entities, capacity, func, chunkIndex, data, targetType1, targetType2, targetType3, targetType4,
							targetType5, targetType6, targetType7](int id)
						{
							for (size_t i = 0; i < capacity; i++)
							{
								size_t index = i + chunkIndex * capacity;
								...
								func(static_cast<int>(index), entity,
								     ...
								     static_cast<T6*>(static_cast<char*>(data) + targetType6.Offset * capacity + (i %
									     capacity) * targetType6.Size),
								     static_cast<T7*>(static_cast<char*>(data) + targetType7.Offset * capacity + (i %
									     capacity) * targetType7.Size)
								);
							}
						}
					).share());
			...
			if (remainder != 0)
			{
				...
				results.push_back(
					_ThreadPool->Push(
						[entities, capacity, func, chunkAmount, data, targetType1, targetType2, targetType3, targetType4
							, targetType5, targetType6, targetType7, remainder](int id)
						{
							for (size_t i = 0; i < remainder; i++)
							{
								size_t index = i + chunkAmount * capacity;
		...
		if (found1 && found2 && found3 && found4 && found5 && found6 && found7 && found8)
		{
			...
			for (int chunkIndex = 0; chunkIndex < chunkAmount; chunkIndex++)
			{
				...
				results.push_back(
					_ThreadPool->Push(
						[entities, capacity, func, chunkIndex, data, targetType1, targetType2, targetType3, targetType4,
							targetType5, targetType6, targetType7, targetType8](int id)
						{
							for (size_t i = 0; i < capacity; i++)
							{
								size_t index = i + chunkIndex * capacity;
								...
								func(static_cast<int>(index), entity,
								     ...
								     static_cast<T7*>(static_cast<char*>(data) + targetType7.Offset * capacity + (i %
									     capacity) * targetType7.Size),
								     static_cast<T8*>(static_cast<char*>(data) + targetType8.Offset * capacity + (i %
									     capacity) * targetType8.Size)
								);
							}
						}
					).share());
			...
			if (remainder != 0)
			{
				...
				results.push_back(
					_ThreadPool->Push(
						[entities, capacity, func, chunkAmount, data, targetType1, targetType2, targetType3, targetType4
							, targetType5, targetType6, targetType7, targetType8, remainder](int id)
						{
							for (size_t i = 0; i < remainder; i++)
							{
								size_t index = i + chunkAmount * capacity;
...
#pragma region Others
	...
	void EntityManager::GetComponentDataArrayStorage(EntityComponentStorage storage, std::vector<T>* container)
	{
		...
		if (search != storage.ArchetypeInfo->ComponentTypes.end())
		{
			...
			{
				memcpy(&container->at(container->size() - remainAmount - capacity * (chunkAmount - i)),
				       static_cast<void*>(static_cast<char*>(storage.ChunkArray->Chunks[i].Data) + capacity * targetType
					       .Offset), capacity * targetType.Size);
			}
			if (remainAmount > 0) memcpy(&container->at(container->size() - remainAmount),
			                             static_cast<void*>(static_cast<char*>(storage.ChunkArray->Chunks[chunkAmount].
				                             Data) + capacity * targetType.Offset), remainAmount * targetType.Size);
		}
	}
...
#pragma region GetSetHas
	...
	void EntityManager::SetComponentData(Entity entity, T value)
	{
		...
		if (_Entities->at(entity.Index) == entity)
		{
			...
			ComponentDataChunk chunk = _EntityComponentStorage->at(info.ArchetypeInfoIndex).ChunkArray->Chunks[
				chunkIndex];
			...
			{
				chunk.SetData<T>(
					static_cast<size_t>(search->second.Offset * chunkInfo->ChunkCapacity + chunkPointer * search->second
						.Size), value);
			}
			else
			{
...
#pragma region SharedQuery
	...
	template <typename T, typename ...Ts>
	void EntityManager::SetEntityQueryAnyFilters(EntityQuery entityQuery, T arg, Ts ...args)
	{
		if (entityQuery.IsNull()) return;
		size_t index = entityQuery.Index;
		if (_EntityQueries->at(index).IsDeleted())
	...
	template <typename T, typename ...Ts>
	void EntityManager::SetEntityQueryNoneFilters(EntityQuery entityQuery, T arg, Ts ...args)
	{
		if (entityQuery.IsNull()) return;
		size_t index = entityQuery.Index;
		if (_EntityQueries->at(index).IsDeleted())
...
#pragma region For Each
	template <typename T1>
	void EntityManager::ForEach(EntityQuery entityQuery, const std::function<void(int i, Entity entity, T1*)>& func)
	{
		if (entityQuery.IsNull()) return;
		size_t index = entityQuery.Index;
		if (_EntityQueries->at(index).IsDeleted())
	...
	template <typename T1, typename T2>
	static void EntityManager::ForEach(EntityQuery entityQuery,
	                                   const std::function<void(int i, Entity entity, T1*, T2*)>& func)
	{
		if (entityQuery.IsNull()) return;
		size_t index = entityQuery.Index;
	...
	template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6>
	static void EntityManager::ForEach(EntityQuery entityQuery,
	                                   const std::function<void(int i, Entity entity, T1*, T2*, T3*, T4*, T5*, T6*)>&
	                                   func)
	{
		if (entityQuery.IsNull()) return;
		size_t index = entityQuery.Index;
...
#pragma endregion
	...
	void EntityManager::GetComponentDataArray(EntityQuery entityQuery, T1 filter, std::vector<T2>* container)
	{
		...
		for (int i = 0; i < collectedDataLists.size(); i++)
		{
			...
			futures.push_back(_ThreadPool->Push(
				[&targetDataList, &componentDataList, size, filter, collectedDataList, i](int id)
				{
	...
	void EntityManager::GetEntityArray(EntityQuery entityQuery, T1 filter, std::vector<Entity>* container)
	{
		...
		for (int i = 0; i < collectedEntityLists.size(); i++)
		{
			...
			futures.push_back(_ThreadPool->Push(
				[&allEntities, &componentDataList, size, filter, collectedEntityList, i](int id)
				{
					for (int j = 0; j < size / 8; j++)
					{
						if (filter == componentDataList[j * 8 + i])
		...
		for (int i = 0; i < collectedEntityLists.size(); i++)
		{
			...
			if (listSize == 0) continue;
			container->resize(container->size() + listSize);
			memcpy(&container->at(container->size() - listSize), collectedEntityLists[i].data(),
			       listSize * sizeof(Entity));
		}
	...
	template <typename T>
	void EntityQuery::ToComponentDataArray(std::vector<T>* container)
	{
