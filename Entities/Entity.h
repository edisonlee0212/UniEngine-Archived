...
#pragma region Storage
	...
	template <typename T>
	T ComponentDataChunk::GetData(size_t offset)
	{
		return T(*static_cast<T*>(static_cast<char*>(Data) + offset));
	}

	template <typename T>
	void ComponentDataChunk::SetData(size_t offset, T data)
	{
		*static_cast<T*>(static_cast<char*>(Data) + offset) = data;
	}
