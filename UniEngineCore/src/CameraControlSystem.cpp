...
void Utilities::CameraControlSystem::Update()
{
...
void Utilities::CameraControlSystem::SetTargetCamera(Entity* targetCameraEntity)
{
...
void Utilities::CameraControlSystem::SetVelocity(float velocity)
{
	_Velocity = velocity;
}

void Utilities::CameraControlSystem::SetSensitivity(float sensitivity)
{
