...
SpaceColonizationTree::SurfaceOfRevolutionEnvelope::SurfaceOfRevolutionEnvelope(glm::vec3 spaceOffset, glm::vec3 spaceSize)
	: Envelope(spaceOffset, spaceSize)
{
}

float SpaceColonizationTree::SurfaceOfRevolutionEnvelope::GetRadius(float height)
{
...
bool SpaceColonizationTree::SurfaceOfRevolutionEnvelope::IsInEnvelope(glm::vec3 point)
{
