...
namespace UniEngine
{
	...
	public:
		...
		void CalculateFrustumPoints(float nearPlane, float farPlane, glm::vec3 cameraPos, glm::quat cameraRot,
		                            glm::vec3* points);
		...
		glm::quat ProcessMouseMovement(float xoffset, float yoffset, float sensitivity,
