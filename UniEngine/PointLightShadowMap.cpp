...
UniEngine::PointLightShadowMap::PointLightShadowMap(size_t amount, float resolutionX, float resolutionY)
{
	...
	_DepthCubeMapArray->SetIntParameter(GL_TEXTURE_CUBE_MAP_ARRAY, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
	_DepthCubeMapArray->SetIntParameter(GL_TEXTURE_CUBE_MAP_ARRAY, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
