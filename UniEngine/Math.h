...
#pragma region Matrix
	...
	inline static float4x4 Ortho(float width, float height, float near, float far)
	{
	...
	/// <param name="near">The distance to the near plane.</param>
	/// <param name="far">The distance to the far plane.</param>
	inline static float4x4 OrthoOffCenter(float left, float right, float bottom, float top, float near, float far)
	{
	...
	inline static float4x4 PerspectiveFov(float verticalFov, float aspect, float near, float far)
	{
	...
	inline static float4x4 PerspectiveOffCenter(float left, float right, float bottom, float top, float near, float far)
	{
		float rcpdz = 1.0f / (near - far);
