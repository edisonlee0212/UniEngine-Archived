...
#pragma region Scene Camera
		...
		std::unique_ptr<GLProgram> m_sceneHighlightPrePassProgram;
		std::unique_ptr<GLProgram> m_sceneHighlightProgram;
		std::unique_ptr<GLProgram> m_sceneHighlightPrePassInstancedProgram;
		std::unique_ptr<GLProgram> m_sceneHighlightInstancedProgram;

		std::unique_ptr<GLProgram> m_sceneCameraEntityRecorderProgram;
		std::unique_ptr<GLProgram> m_sceneCameraEntityInstancedRecorderProgram;
